...
class MyEffect(inkex.Effect):
  def __init__(self):
    ...
    self.arg_parser.add_argument("--penup-feedrate",
                      action="store", type=float,
                      dest="penup_feedrate", default="3500.0",
                      help="penup feedrate in mm/min")
  ...
  def effect(self):
    self.context = GCodeContext(self.options.xy_feedrate,self.options.penup_feedrate, self.options.z_feedrate, 
