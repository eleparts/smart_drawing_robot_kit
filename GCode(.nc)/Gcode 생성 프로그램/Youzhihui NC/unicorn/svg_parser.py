...
import inkex, simplepath # ,simplestyle,  cspsubdiv , cubicsuperpath
...
class SvgPath(unicorn.entities.PolyLine):
  def load(self, node, mat):
    ...
    # p = p.transform(mat, True)

    # p = CubicSuperPath(d)
    # p = Path(p).to_absolute().transform(mat, True)
...
class SvgParser:
  ...
  def recursivelyTraverseSvg(self, nodeList, 
    ...
    for node in nodeList:
      ...
      try:
        matNew = Transform(matCurrent) * Transform(node.get("transform", None))   
...
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:265: DeprecationWarning: simpletransform.parseTransform -> Transform(str).matrix
#   matNew = composeTransform(matCurrent, parseTransform(node.get("transform")))
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:265: DeprecationWarning: simpletransform.composeTransform -> Transform(M1) * Transform(M2)
#   matNew = composeTransform(matCurrent, parseTransform(node.get("transform")))
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:78: DeprecationWarning: simplepath.parsePath -> element.path.to_arrays()
#   if len(simplepath.parsePath(d)) == 0:
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:80: DeprecationWarning: cubicsuperpath.parsePath -> None
#   p = cubicsuperpath.parsePath(d)
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:81: DeprecationWarning: simpletransform.applyTransformToPath -> Path(path).transform(mat)
#   applyTransformToPath(mat, p)
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:54: DeprecationWarning: inkex.bezier.maxdist -> Get maximum distance within bezier curve
#   if cspsubdiv.maxdist( b ) > flat:
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:59: DeprecationWarning: inkex.bezier.beziersplitatt -> Split bezier at given time
#   one, two = beziersplitatt( b, 0.5 )
# sys:1: DeprecationWarning: Use `save()` or `save_raw()` instead.



# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:267: DeprecationWarning: simpletransform.parseTransform -> Transform(str).matrix
#   matNew = simpletransform.composeTransform(matCurrent, simpletransform.parseTransform(node.get("transform")))
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:267: DeprecationWarning: simpletransform.composeTransform -> Transform(M1) * Transform(M2)
#   matNew = simpletransform.composeTransform(matCurrent, simpletransform.parseTransform(node.get("transform")))
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:80: DeprecationWarning: simplepath.parsePath -> element.path.to_arrays()
#   if len(simplepath.parsePath(d)) == 0:
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:82: DeprecationWarning: cubicsuperpath.parsePath -> None
#   p = cubicsuperpath.parsePath(d)
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:83: DeprecationWarning: simpletransform.applyTransformToPath -> Path(path).transform(mat)
#   simpletransform.applyTransformToPath(mat, p)
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:56: DeprecationWarning: inkex.bezier.maxdist -> Get maximum distance within bezier curve
#   if cspsubdiv.maxdist( b ) > flat:
# C:\Program Files\Inkscape\share\inkscape\extensions\unicorn\svg_parser.py:61: DeprecationWarning: inkex.bezier.beziersplitatt -> Split bezier at given time
